<template>
    <div class="home">
        <!-- 头部 -->
        <van-nav-bar title="首页" right-text="未登录" @click-right="onClickRight" fixed z-index="2">
        ...
        <div class="carousel">
            <van-swipe :autoplay="2000">
                <van-swipe-item class="carousel-item" v-for="(image, index) in carouselItem" :key="index">
